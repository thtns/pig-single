...
import com.thtns.cloud.component.ComicDaoAuthenticationProvider;
import com.thtns.cloud.grant.CustomAppAuthenticationProvider;
import com.thtns.cloud.handler.FormAuthenticationFailureHandler;
import com.thtns.cloud.handler.SsoLogoutSuccessHandler;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) {
        ComicDaoAuthenticationProvider daoAuthenticationProvider = new ComicDaoAuthenticationProvider();
