...
import com.thtns.cloud.entity.SysLog;
import com.thtns.cloud.mapper.SysLogMapper;
import com.thtns.cloud.request.SysLogRequest;
import com.thtns.cloud.service.SysLogService;
...
public class SysLogServiceImpl extends ServiceImpl<SysLogMapper, SysLog> implements SysLogService {
	...
	@Override
	public Page getLogByPage(Page page, SysLogRequest sysLog) {
	 ...
	 */
	@Override
	public List getLogList(SysLogRequest sysLog) {
	 ...
	 */
	private LambdaQueryWrapper buildQueryWrapper(SysLogRequest sysLog) {
