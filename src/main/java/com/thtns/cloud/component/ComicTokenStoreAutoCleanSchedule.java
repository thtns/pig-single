...
import com.thtns.cloud.utils.SpringContextHolder;
...
public class ComicTokenStoreAutoCleanSchedule {
	...
	public void doMaintenance() {
		ComicRedisTokenStore tokenStore = SpringContextHolder.getBean(ComicRedisTokenStore.class);
