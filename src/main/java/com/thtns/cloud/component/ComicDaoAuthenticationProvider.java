...
import com.thtns.cloud.utils.WebUtils;
 ...
 */
@Configuration
public class ComicDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	private static final String ENCODE_KEY = "thanks,pig4cloud";
	...
	public ComicDaoAuthenticationProvider() {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		String password = aes.decryptStr(presentedPassword);
