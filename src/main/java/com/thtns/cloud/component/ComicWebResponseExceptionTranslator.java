...
import com.thtns.cloud.exception.*;
 ...
 */
@Slf4j
public class ComicWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new ComicAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
