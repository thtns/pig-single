...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return userVo
	 */
	UserResponse getUserVoByUsername(String username);
	 ...
	 * @return list
	 */
	IPage<List<UserResponse>> getUserVosPage(Page page, @Param("query") UserRequest userRequest);
	 ...
	 * 查询用户列表
	 *
	 * @param userRequest 查询条件
	 * @return
	 */
	List<UserResponse> selectVoList(@Param("query") UserRequest userRequest);
